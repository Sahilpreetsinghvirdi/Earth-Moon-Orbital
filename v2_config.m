...
config.mission.lunarApproachDuration_days = 1.0;
...
config.live = struct('frameStride', 4, 'pause_s', 0.01, 'speedFactor', 100000, 'cameraMode', 'earth', 'smoothPath', true, 'smoothSamplesPerPoint', 4);
