...
config.mission.lunarApproachSafetyAltitude_m = 1000000;
...
config.live = struct('frameStride', 4, 'pause_s', 0.01, 'speedFactor', 100000, 'cameraMode', 'earth', 'smoothPath', false, 'smoothSamplesPerPoint', 1);
